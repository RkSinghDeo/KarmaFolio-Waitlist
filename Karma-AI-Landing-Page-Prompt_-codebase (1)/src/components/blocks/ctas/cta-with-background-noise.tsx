    ...
    <section className="w-full grid grid-cols-1 md:grid-cols-2 my-20 md:my-40 justify-start relative z-20 max-w-7xl mx-auto bg-gradient-to-br from-slate-800 dark:from-neutral-900 to-gray-900 sm:rounded-2xl">
      ...
      <div className="relative sm:rounded-2xl overflow-hidden px-6 md:px-8 ">
        ...
        <div className="relative px-0 py-10 sm:px-10 sm:pt-20 sm:pb-10 lg:px-10">
          <h2 className="text-left text-balance text-2xl md:text-3xl lg:text-5xl font-semibold tracking-[-0.015em] text-primary" style={{fontFamily:'var(--font-display)'}}>
            Be one of the first to build your Karmafolio
          </h2>
          <p className="mt-8 max-w-[26rem] text-left text-base/6 text-neutral-700">
            Secure your spot and help shape the future of giving.
          </p>

          <button className="mt-8 flex space-x-2 items-center group text-base px-4 py-2 rounded-lg bg-gradient-to-b from-[var(--color-accent)] to-orange-400 text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]">

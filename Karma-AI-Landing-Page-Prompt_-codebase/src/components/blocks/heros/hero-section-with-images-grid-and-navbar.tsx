...
export function HeroSectionWithImagesGrid() {
  return (
    <div className="relative w-full overflow-hidden bg-[var(--color-background)]" style={{ backgroundColor: 'rgba(255,252,247, 0.98)' /* soft warm white */ }}>
      <Navbar />
      <div className="relative flex flex-col items-center justify-center overflow-hidden px-4 pb-10 md:px-8">
        <div className="relative mt-24 flex flex-col items-center justify-center">
          <FeaturedImages />
          <h1
            className="mb-5 mx-auto mt-8 max-w-4xl text-center text-3xl font-bold leading-tight tracking-tight text-primary md:text-5xl lg:text-7xl"
            style={{ fontFamily: 'Inter', color: 'var(--color-primary)', letterSpacing: '-0.01em' }}
          >
            Your best in class{" "}
            <span className="relative z-10 bg-gradient-to-b from-[var(--color-primary)] to-[var(--color-sage)] bg-clip-text text-transparent">
              design and development studio
            </span>{" "}
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="inline-block h-12 w-12 align-[-0.5em]"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                strokeWidth="2"
              ...
              >
                ...
                <motion.path
                  initial={{ pathLength: 0, fill: '#FF7A5A', opacity: 0 }}
                  animate={{ pathLength: 1, fill: '#FF7A5A', opacity: 1 }}
                  transition={{
                    duration: 1.5,
                    repeat: Infinity,
                    repeatType: 'reverse',
          ...
          <h2
            className="font-normal relative mx-auto mb-8 mt-1 max-w-2xl text-center text-lg tracking-wide"
            style={{ color: 'var(--color-sage)', fontFamily: 'Inter', fontWeight: 400, letterSpacing: '0.03em', lineHeight: 1.5 }}
          >
            We provide the best in class design and development services for teams that ship with the speed of light.
          </h2>
        </div>
        {/* Extra calm margin/padding between subheading and button */}
        <LogoCloudMarquee />
      </div>
      <ImagesGrid />
    </div>
